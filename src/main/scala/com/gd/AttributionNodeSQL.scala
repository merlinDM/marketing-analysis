...
import org.apache.spark.sql.functions.{coalesce, collect_list, concat, explode_outer, first, lag, lit, sum}
import org.apache.spark.sql.types.{IntegerType, StringType}

class AttributionNodeSQL(cfg: AttributionNodeConfiguration) extends JoinNode {
